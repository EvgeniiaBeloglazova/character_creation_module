...
def attack(char_name: str, char_class: str) -> str:
    """Описание действия атака."""

    if char_class == 'warrior':
        attack_number = 5 + randint(3, 5)
        return (
            f'{char_name} нанёс урон противнику равный'
            f'{attack_number}'
        )
    if char_class == 'mage':
        attack_number = 5 + randint(5, 10)
        return (
            f'{char_name} нанёс урон противнику равный'
            f'{attack_number}'
        )
    if char_class == 'healer':
        attack_number = 5 + randint(-3, -1)
        return (
            f'{char_name} нанёс урон противнику равный'
            f'{attack_number}'
        )
